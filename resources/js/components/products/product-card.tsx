...
export function ProductCard({
    ...
    const { addToCart, updateQuantity, addingToCart, updatingItems } =
        cartActions;
    ...
    const productNameElement = onProductClick ? (
        <button
            ...
            className="mb-2 text-left text-lg font-semibold hover:text-primary transition-colors"
        >
            {product.name}
        </button>
    ) : (
        <Link
            ...
            className="mb-2 block text-lg font-semibold hover:text-primary transition-colors"
        >
            {product.name}
        </Link>
    );
            ...
            return (
                <div className="flex w-full items-center justify-between rounded-md border">
                    ...
                    <Button
                        ...
                        disabled={
                            cartItem!.quantity >= product.stock || isUpdating
                        }
                    >
